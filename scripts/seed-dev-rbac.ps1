...
VALUES
    ...
    ('$TenantID', '$AllowedRoleID', 'inventory.transfer.read'),
    ('$TenantID', '$AllowedRoleID', 'inventory.transfer.write'),
    ('$TenantID', '$AllowedRoleID', 'inventory.stock_count.read'),
    ('$TenantID', '$AllowedRoleID', 'inventory.stock_count.write'),
    ('$TenantID', '$AllowedRoleID', 'inventory.reservation.read'),
    ('$TenantID', '$AllowedRoleID', 'inventory.reservation.write'),
    ('$TenantID', '$AllowedRoleID', 'inventory.cost.read'),
    ('$TenantID', '$AllowedRoleID', 'inventory.cost.write'),
    ('$TenantID', '$AllowedRoleID', 'inventory.report.read'),
    ('$TenantID', '$AllowedRoleID', 'purchase.supplier.read'),
    ('$TenantID', '$AllowedRoleID', 'purchase.supplier.write'),
    ('$TenantID', '$AllowedRoleID', 'purchase.order.read'),
    ...
    ('$TenantID', '$AllowedRoleID', 'sales.customer.read'),
    ('$TenantID', '$AllowedRoleID', 'sales.customer.write'),
    ('$TenantID', '$AllowedRoleID', 'sales.order.read'),
    ('$TenantID', '$AllowedRoleID', 'sales.order.create'),
    ('$TenantID', '$AllowedRoleID', 'sales.order.approve'),
    ('$TenantID', '$AllowedRoleID', 'sales.issue.read'),
    ('$TenantID', '$AllowedRoleID', 'sales.issue.write'),
    ('$TenantID', '$AllowedRoleID', 'sales.issue.reverse')
